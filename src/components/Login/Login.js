...
function Login() {
    ...
    return (
        <div className="login">
            <img src="https://www.freepnglogos.com/uploads/linkedin-logo-transparent-png-16.png" alt="login logo"/>
            ...
            <p>Not a memeber?{" "}
                <span className="loginRegister" onClick={registerHandler}>Register Now</span>
            </p>
        </div>
    )
}
